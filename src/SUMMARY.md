...
- [Get an element from type name](./flows/GetElementFromTypeName.md)
- [Get a type definition from sample and type name](./flows/GetTypeDefinitionFromSampleAndTypeName.md)
